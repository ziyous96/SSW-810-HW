""" author: Ziyou Shang
These are the test cases for HW11
"""
import unittest

from HW11_Ziyou_Shang import Repository, Major, Instructor, file_reading_gen, Student, main
...
class TestHW10(unittest.TestCase):
    ...
    def test_normal_case(self):
        ...
        db_path = 'Users/shang/Desktop/homework/test1/810_hw.db'
        r = Repository(test1, db_path)
        m = Major()
        m.name = 'SFEN'
        m.required = ['SSW 540', 'SSW 555', 'SSW 810']
        m.elective = ['CS 501', 'CS 546']
        ...
        s = Student('Jobs, S', 'SFEN', '10103')
        s.course_grade = {'SSW 810': 'A-', 'CS 501': 'B'}
        ...
        i = Instructor('Cohen, R', 'SFEN', '98764')
        i.course_student = {'CS 546': 1}
        self.assertEqual(r.instructors['98764'].name, i.name)
        self.assertEqual(r.instructors['98764'].depart, i.depart)
        self.assertEqual(r.instructors['98764'].course_student, i.course_student)
